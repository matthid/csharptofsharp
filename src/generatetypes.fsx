// From https://github.com/kekyo/Microsoft.CodeAnalysis.ActivePatterns/blob/master/Microsoft.CodeAnalysis.ActivePatterns.Generator/Program.fs
#r "paket:
nuget FSharp.Core
...
#load ".fake/generatetypes.fsx/intellisense.fsx"
